...
echo "__AJAX-";
	...
	if($reg_token!="")
	{
        ...
        if($conn->query($sql))
		{
			...
			echo "".$key_;
			echo "__AJAX-";
			$mes='Hi  '.$fname.',We’re Sending you this message because You requested a password reset. click on this link to create a new password: \n /n http://localhost/ECOM-US_SIT/RESET/?i='.$RESET_token_key.'';
