  ...
  <?php include 'header.php';?> 
    ...
    <section class="about-section">
        <h1>Looking for custom food & drink packaging?</h1>
        <p>
        ...
        <p>
          At TBH Packaging ® we have a wealth of experience in custom printed food & drink packaging and are able to brand our 'off the shelf' products with your logo. We're also able to create fully bespoke packaging products.
        </p>
        <p>
          We print trays, coffee cups, smoothie cups, kraft bowls, deli boxes, bags, greaseproof paper, to name just a few products! If you'd like some additional information, such as pricing and lead times, please contact us at <a href="mailto:sales@tbhpackaging.co.uk">sales@tbhpackaging.co.uk</a> with your requirements and a member of our experienced team will guide you through the process.
        </p>
      </section>
