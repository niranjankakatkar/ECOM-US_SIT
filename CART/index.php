                                            ...
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a
                                                                href="product-left-thumbnail.html"><?= givedata($conn, "products", "key_", $product_key, "product_title") ?></a><br>
                                                                <h4 class="table-title text-content">
                                                                <h5><b>Price </b>: £ <?= $row['rate'] ?> <del class="text-content">£ <?= $row['rate'] ?></del></h5></h4><br>
                                                                <h4 class="table-title text-content">
